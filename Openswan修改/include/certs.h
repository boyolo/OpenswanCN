...
extern bool load_cert(bool forcedtype, const char *filename, int verbose, const char *label, cert_t *cert);
...
extern rsa_privkey_t *load_rsa_private_key(const char *filename, int verbose, prompt_pass_t *pass);
extern bool load_coded_file(const char *filename, prompt_pass_t *pass, int verbose, const char *type, chunk_t *blob, bool *pgp);

#ifdef HAVE_LIBNSS
extern bool load_cert_from_nss(bool forcedtype, const char *nssHostCertNickName, int verbose, const char *label, cert_t *cert);
